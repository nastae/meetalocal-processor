...
public class OnlineEmailSenderConfig {
    ...
    public static final TriFunction<OnlineMeet, List<MeetEngagement>, String, EmailSenderConfig> TOURIST_REQUEST_CONFIG = (meet, engagements, websiteUrl) -> {
        ...
        model.put("engagements", engagements
                ...
                .map(e -> {
                    ...
                    volunteer.setSkypeName(HTMLSymbolEncoderUtils.encode(volunteer.getSkypeName()));
    ...
    public static final TriFunction<OnlineMeet, Volunteer, MeetEngagement, EmailSenderConfig> VOLUNTEER_INFORMATION_CONFIG = (meet, v, e) -> {
        Calendar date = Calendar.getInstance();
        date.setTime(meet.getDate());
        Calendar time = Calendar.getInstance();
        time.setTime(e.getTime());
